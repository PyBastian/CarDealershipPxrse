...
export async function Footer() {
  ...
  return <footer className="footer"><div className="shell footer-grid">
    <div><div className="brand"><span className="brand-mark">MK</span>{settings.brandName}</div><p>{settings.siteDescription}</p></div>
  ...
  </div><div className="shell footer-bottom">© {new Date().getFullYear()} {settings.brandName}. Todos los derechos reservados.</div></footer>;
}
