...
export async function Footer() {
  ...
  return <footer className="footer"><div className="shell footer-grid">
    <div><div className="brand"><span className="brand-mark">N</span>{settings.brandName}</div><p>{settings.siteDescription}</p></div>
    <div><span className="eyebrow">Explora</span><Link href="/autos">Autos disponibles</Link><Link href="/contacto">Contacto</Link><Link href="/admin">Administración</Link></div>
